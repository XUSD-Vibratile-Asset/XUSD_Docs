...
import { GithubIcon, Send, HexagonIcon } from "lucide-react";
      ...
      <div className="sm:p-3 p-2 max-w-[1530px] mx-auto h-full flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <div className="flex">
              <Link
                href="https://github.com/XUSD-Vibratile-Asset/XUSD_Docs"
                className={buttonVariants({ variant: "ghost", size: "icon" })}
              >
                <GithubIcon className="h-[1.1rem] w-[1.1rem]" />
              </Link>
              <Link
                href="https://t.me/XUSDOfficial"
...
export function Logo() {
  return (
    <Link href="/" className="flex items-center gap-2.5">
      <Image src={"/logoMain.png"} width={100} height={100} alt="mooo"></Image>
