...
## Important Voting Verdict (this will come into play somewhere in the forseeable future, specifically under the power of the SENATOR rank)
...
This bot will act as a portal, so that if a user has contributed towards the protocol, or helped out in some benevolent way, or a user is known to create rugpulls. This is so that other users can flag those Actors in the system for future reference.