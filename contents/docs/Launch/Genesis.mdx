...
This project is heavily focused on both the community, and teamwork. The rank of LEGATUS will grant you special permissions on the contract level, so that you can add the token LP all by yourself to get those Millions of XUSD to your community. There will be a special page for leaders to add LP tokens. You can read more about the LEGATUS rank in the [Praetorship Dev] (https://xusd-docs.vercel.app/docs/PraetorshipDev/PraetorshipDev)
