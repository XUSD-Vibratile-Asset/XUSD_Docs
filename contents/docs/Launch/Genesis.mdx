...
### Genesis Phase Tokens go as: (PLS, PLSX, INC, eHEX, pHEX, pDAI, Atropa, 1SWAP, LOVE.IO, BFF, AFFECTION™, NBA™, Teddybear㉾, A1A, Finvesta, FKO, FRENS, DEX, LEMON and SIMP.)
...
And, also each user will be capped at about 2,500 XUSD per epoch per LP pair. These values are adjustable as we want to make sure that the XUSD tokens are being distributed correctly. The Genesis phase is meant to be a distribution to the community before the project actually fully starts.
We also decided this unique approach, because individual community leaders will be able to whitelist their token LP as long as it is made with XUSD, or they could launch a new token as well. **This gives your individual communities a great opportunity to grow**, as well as use our marketing and reach to strengthen your communities. When 
you all grow, we all grow together. We are primed to grow exponentially this upcomming bull run.   

### How long will it last? 
Genesis will run for a maximum of **25 weeks**. We say maximum because we will play it by ear as time goes on. Nobody has ever done this kind of Genesis before, and it's just the begining of the project itself. Once the supply looks effecient for amazing growth, we will transition into the next phase of the protocol. 
This also means that we will have a max initial supply of around 1,000,000,000 tokens. That's 40,000,000 tokens a week. When we get to peg, that is the equivelent of giving out $40 Million a week!
