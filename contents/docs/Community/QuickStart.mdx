...
This section will help you get started with the necessary steps and provide the necessary materials to engage with PulseChain and utilize Vibratile Tokens such as XUSD effectively.
...
1. **(PLS, PLSX, INC, eHEX, pHEX, pDAI, Atropa, 1SWAP, LOVE.IO, BFF, AFFECTION™, NBA™, Teddybear㉾, A1A, Finvesta, FKO, FRENS, DEX, LEMON and SIMP.)**
...
Stay informed about the protocol launch sequence. Active participation within communities on social media ensures you are up to date with the developments of the protocol. We are looking forward to having you on board in our Telegram channel and Twitter/X. You can find the links on the frontpage of the XUSD website.



## How do you buy XUSD outside of Genesis Staking?

You will be able to trade the pairs on multiple PulseChain DEXes such as PulseX V2, Piteas and others. Keep in mind, in a Vibratile token system, there are associated taxes. You can find more information on those taxes in particular to XUSD in the [Dynamic Vibratile Credit](https://xusd-docs.vercel.app/docs/DynamicVibeOverview/DynamicVibeOverview).
