...
---
title: What are the benefits of owning a VibePass?
description:
---
...
There will be a linear scale pegged to the price of a VibePass, so if you can not afford a VibePass now, do not worry. But, purchasing one now as stated above will open you up to more benefits than other users. 
So, the choice is yours. Personally, we highly recommend you to get a VibePass now than later, as a VibePass is your key to financial freedom, your key to frictionless and absolute decentralised banking.
...
---
title: How many VibePasses can a wallet own?
description:
---
